...
import com.deepblue.cleaning.activity.index
...
class MapAdapter2(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (null == view) {
            ...
            holder.rl_newmap = view.findViewById(R.id.rl_newmap)
            view.tag = holder;
        } else {
...
//            val map = MapUtilsB.mapToBitmap(mapList!![position])
            holder.img_map!!.visibility = View.VISIBLE
            holder.rl_newmap!!.visibility = View.GONE
...
//            if (map != null) {
//                holder.img_map!!.setImageBitmap(map)
//            } else {
//                holder.img_map!!.setImageBitmap(BitmapFactory.decodeResource(context.resources, R.drawable.transpant))
//            }
            if (index == position) {
                holder.rl_mapbg!!.setBackgroundResource(R.drawable.map_background)
            } else {
                holder.rl_mapbg!!.setBackgroundResource(R.drawable.select_map)
            }
        } else {
            holder.img_map!!.visibility = View.GONE
            holder.rl_newmap!!.visibility = View.VISIBLE
            holder.tv_mapname!!.text = context.getText(R.string.add_roomlist)
        }
    ...
    internal class ViewHolder {
        ...
        var rl_newmap: RelativeLayout? = null
    }
}